...
if (global.config.video.fullscreen.active == true) // Draws black rectangles to cover drawings that go off-screen
{
...
if (global.config.video.showFps.active == true) // Draws FPS
{
...
if (global.config.video.showBdr.active == true) // Draws Border
{
