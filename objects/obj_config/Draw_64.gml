...
{
	var _res_width = global.config.video.width;
	var _res_height = global.config.video.height;
...
if (global.config.video.showVer.act == true) // Draws Version
{
	...
	var _showVer_x = (global.config.video.width - 4 - _showVer_width);
	var _showVer_y = (global.config.video.height - 4 - _showVer_height);
