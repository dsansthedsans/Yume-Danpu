...
switch (object_index)
{
	...
	case obj_actor_user_func_kart:
		if (passengers[0].id != undefined)
		{
			...
			fn_draw_spr_part(_passenger_sprite, 0, _myself_x, (_myself_y - fn_spr_height(_passenger_sprite)), 0, 0, fn_spr_width(_passenger_sprite), (round(fn_spr_height(_passenger_sprite) / 1.5) + 1));
